...
const routeDesk = [
  {
    ...
    title: "기록으로 보는 바른푸드",
    description: "연혁, 인증, 위치처럼 회사를 판단할 기본 기록을 확인하세요.",
    focus: "연혁 · 인증 · 위치",
    action: "기업 기록 보기",
    href: "/company",
    Icon: Landmark,
  },
  {
    ...
    title: "반복되는 맛의 관리 방식",
    description: "입력 조건, 공정 확인, 출고 기준을 한 흐름으로 살펴보세요.",
    focus: "입력 · 공정 · 출고",
    action: "제조 기준 보기",
    href: "/manufacturing",
    Icon: ShieldCheck,
  },
  {
    ...
    title: "운영에 맞는 제품 파일",
    description: "제품군과 사용 조건을 좁혀 상담 전에 필요한 파일을 찾으세요.",
    focus: "제품군 · 사용 조건 · 규격",
    action: "제품 파일 열기",
    href: "/products",
    Icon: PackageSearch,
  },
  {
    ...
    description: "수량, 일정, 개발 범위를 정리해 상담의 출발점을 잡습니다.",
    focus: "수량 · 일정 · 개발 범위",
    action: "협업 범위 보기",
    href: "/partnership",
    Icon: FileText,
...
const proofRecords = [
  { number: "2008", label: "DOUGH RESEARCH", text: "도우 연구의 시작", href: "/company" },
