...
const products: Product[] = [
  ...
  { id: "foodservice", name: "푸드서비스 도우", category: "도우", file: "DOUGH / PRODUCT FILE 04", description: "납품 단위와 보관 방식을 맞춰 공급하는 푸드서비스용 도우 제품군입니다.", tags: ["도우", "식자재", "납품", "푸드서비스"], image: "https://images.unsplash.com/photo-1574126154517-d1e0d89ef734?auto=format&fit=crop&w=1500&q=88", serving: "푸드서비스 채널의 보관 방식, 납품 단위, 사용 목적에 맞춰 규격을 안내합니다.", nutrition: [["1회 제공량", "제품 규격서 기준"], ["열량", "포장 라벨 기준"], ["탄수화물", "포장 라벨 기준"], ["단백질", "포장 라벨 기준"], ["지방", "포장 라벨 기준"], ["나트륨", "포장 라벨 기준"]], specifications: [["제품 구분", "도우 제품군"], ["활용 범위", "푸드서비스·식자재"], ["납품 단위", "수량·지역 기준 안내"], ["알레르기 정보", "실제 제품 라벨 기준 확인"]], storage: "보관·해동 기준은 출고 제품의 포장 라벨과 최신 제품 규격서를 기준으로 안내합니다.", preparation: "제품의 실제 사용 목적에 따라 권장 조리·해동 조건을 안내합니다." },
