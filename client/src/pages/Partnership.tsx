...
const checklist = ["제품 또는 메뉴 유형", "실제 사용 환경과 장비", "예상 수량 또는 납품 단위", "희망 일정", "정리가 필요한 조건"];
