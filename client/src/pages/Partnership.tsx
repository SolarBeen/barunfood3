...
export default function Partnership() {
  ...
  return (
    <SubPageLayout marker="04" eyebrow="PARTNERSHIP BRIEF" heroVariant="partnership" heroImage="/assets/barun-product-sample-collaboration.webp" heroImageAlt="제품 샘플을 검토하는 협업 장면" title={<>답을 정하기 전에,<br /><span className="text-[#9e3328]">조건부터 읽습니다.</span></>} description="제품 납품, 맞춤 개발, OEM·ODM. 협업의 방식보다 먼저 필요한 조건과 가능한 범위를 함께 정리합니다.">
