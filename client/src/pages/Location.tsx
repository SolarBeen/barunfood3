      ...
      <FadeInSection className="bg-[#f7f3eb] px-5 py-20 sm:px-8 sm:py-28 lg:px-12 lg:py-36">
        <div className="mx-auto grid max-w-[1440px] gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20">
          <div>
            ...
            <h2 className="mt-8 font-serif text-[clamp(2.45rem,4.5vw,4.8rem)] font-semibold leading-[1.04] tracking-[-0.08em]">방문 전에,<br /><span className="text-[#9e3328]">주소와 일정을 확인하세요.</span></h2>
            <p className="mt-7 max-w-sm text-sm leading-7 text-[#70685d]">제품 상담, 샘플 확인, 납품 논의를 위해 방문하실 경우 먼저 전화로 목적과 희망 일정을 알려주세요.</p>
          </div>
          <div className="border-t border-[#cfc5b5]">
            ...
            <div className="grid gap-4 border-b border-[#cfc5b5] py-7 sm:grid-cols-[150px_1fr]"><span className="text-[10px] font-bold tracking-[0.18em] text-[#9e3328]">VISIT NOTE</span><p className="text-sm leading-7 text-[#70685d]">원활한 방문을 위해 사전 연락 후 담당자와 일정, 방문 목적, 필요한 자료를 확인해 주세요.</p></div>
